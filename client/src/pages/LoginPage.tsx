      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-gray-900 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center justify-center space-x-3"
          >
